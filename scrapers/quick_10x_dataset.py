...
def main():
    ...
    strategies = [
        {
            ...
            "args": [
                ...
                "--max-browsers", "8",
                "--max-pages", "40",
                "--outfile", "data/ford_transit_deep_commercial.csv"
            ],
            "expected": 2000
        },
        
        {
            ...
            "args": [
                ...
                "--max-browsers", "10", 
                "--max-pages", "50",
                "--outfile", "data/ford_transit_wide_mixed.csv"
            ],
            "expected": 2500
        },
        
        {
            ...
            "args": [
                ...
                "--max-browsers", "6",
                "--max-pages", "30",
                "--outfile", "data/ford_transit_cities_deep.csv"
            ],
            "expected": 1800
        },
        
        {
            ...
            "args": [
                ...
                "--max-browsers", "8",
                "--max-pages", "35",
                "--outfile", "data/ford_transit_geographic_thorough.csv"
            ],
            "expected": 2000
        }
    ]
    ...
    all_files = [
        "data/ford_transit_uk_complete.csv",  # Original
        "data/ford_transit_deep_commercial.csv",
        "data/ford_transit_wide_mixed.csv", 
        "data/ford_transit_cities_deep.csv",
        "data/ford_transit_geographic_thorough.csv"
    ]
    ...
    # Save mega dataset
    mega_file = "data/ford_transit_10X_MEGA_dataset.csv"
